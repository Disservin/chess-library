...
class Board {
   ...
   public:
    ...
    /**
     * @brief Returns all pieces of two types and color
     * @param type1, type2
     * @param color
     * @return
     */
    [[nodiscard]] Bitboard pieces(PieceType type1, PieceType type2, Color color) const {
     ...
     * @return
     */
    [[nodiscard]] Bitboard pieces(PieceType type) const { return pieces_bb_[type]; }
