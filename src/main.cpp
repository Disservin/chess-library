...
int main() {
    ...
    board.loadFen("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w AHah - 0 1");
    ...
    board.loadFen("1rqbkrbn/1ppppp1p/1n6/p1N3p1/8/2P4P/PP1PPPP1/1RQBKRBN w FBfb - 0 9");
    totalNodes += perft.testPositionPerft(board, 6, 191762235ull);

    board.loadFen("rbbqn1kr/pp2p1pp/6n1/2pp1p2/2P4P/P7/BP1PPPP1/R1BQNNKR w HAha - 0 9");
    totalNodes += perft.testPositionPerft(board, 6, 924181432ull);

    board.loadFen("rqbbknr1/1ppp2pp/p5n1/4pp2/P7/1PP5/1Q1PPPPP/R1BBKNRN w GAga - 0 9");
    totalNodes += perft.testPositionPerft(board, 6, 308553169ull);

    board.loadFen("4rrb1/1kp3b1/1p1p4/pP1Pn2p/5p2/1PR2P2/2P1NB1P/2KR1B2 w D - 0 21");
    totalNodes += perft.testPositionPerft(board, 6, 872323796ull);

    board.loadFen("1rkr3b/1ppn3p/3pB1n1/6q1/R2P4/4N1P1/1P5P/2KRQ1B1 b Dbd - 0 14");
